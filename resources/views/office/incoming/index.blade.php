			...
			<tbody class="">
				...
				<tr class="{{ $loop->iteration % 2 == 0 ? 'bg-green-200' : 'bg-white' }}  border-b dark:bg-gray-800 dark:border-gray-700">
					...
					<td class="px-6 py-4 flex space-x-3">
						<a href="{{ url('/office-incoming/' . $file->file->id . '/edit') }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><i class="fa-solid fa-eye" style="color: #2977ff;"></i></a>
						<button id="thumbsUpButton" data-id="{{$file->file->id}}" data-modal-target="accept-modal" data-modal-toggle="accept-modal" class="font-extra bold text-blue-600 dark:text-blue-500 hover:underline">
