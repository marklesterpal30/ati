    ...
    <div class="flex  space-x-3">
        ...
        <div class="space-y-4 shadow-xl rounded-md bg-white px-1">
            ...
            <div class="ml-3">
                ...
                <div class="flex space-x-3 ml-2">
                    ...
                    <div>
                        <h1 class="bg-green-200 w-fit px-4 py-2 rounded-md text-xl font-bold inline-block mb-3">Send By: <span class="font-semibold">{{ Auth::user()->name }}</span></h1><br>
        ...
        @if($file->fowarded_date && $file->type === 'incoming')
            ...
            <div class="flex space-x-3 ml-2">
                ...
                <div>
                     <h1 class="bg-green-200 w-fit px-4 py-2 rounded-md text-xl font-bold  mb-6">Forwarded To: <span class="font-semibold">{{ $file->forwarded->name }}</span></h1>
                </div>
            </div>
        @endif
        @if($file->accepted_date)
           ...
           <div class="flex space-x-3 ml-2">
            ...
            <div>
                 ...
                 <h1 class="bg-green-200 w-fit px-4 py-2 rounded-md text-xl font-bold mb-6">Accepted By: <span class="font-semibold">{{ $file->head->head }}</span></h1>
