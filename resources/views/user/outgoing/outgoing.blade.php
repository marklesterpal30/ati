...
<div class="p-0">
    ...
    <form action="{{ url('/creator-file') }}" method="POST" enctype="multipart/form-data"  class="bg-white shadow-xl rounded-md p-4 sm:p-12 flex flex-col space-y-14 ">
        @csrf
        <!------FILE UPLOAD------>
       ...
       <div class="flex justify-between items-start ">
            ...
            <div id="INPUTS" class="flex flex-col justify-center items-center w-full sm:w-1/2 p-2 bg-green-50 rounded-md">
                ...
                <div class=" p-2 w-full">
                    ...
                    <select name="category" class="block w-full text-lg rounded-sm py-2.5 px-2 bg-green-200 border-2 border-green-400" required>
