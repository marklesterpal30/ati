...
<body>
    ...
    <div class="flex justify-center bg-pink-400">     
            <h1 class="z-50  absolute mt-12 sm:mt-8  text-4xl sm:text-5xl text-center  font-bold text-white opacity-100"><span class="text-green-600 text-6xl">A</span>gricultural <span class="text-green-600 text-6xl">T</span>raining <span class="text-green-600 text-6xl">I</span>nstitute</h1>
