		...
		<div style="background-image: url('{{ asset('storage/images/loginbg.jpg') }}');" class="bg-cover h-screen relative w-full overflow-hidden">
			...
			<div class="flex items-center justify-center mt-9 sm:mt-6 px-6 py-8 w-screen mx-auto h-screen lg:py-0">
				<div class="w-full sm:w-1/3 z-50 bg-white opacity-95 rounded-lg shadow dark:border xl:p-0">
					<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
						...
						<form id="loginForm" class="space-y-4 md:space-y-6" action="{{ url('/login') }}" method="POST" autocomplete="off">
							...
							<div class="flex items-center justify-between">
								<div class="flex items-start">
									<div class="flex items-center h-5">
										<input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" autocomplete="off" required="">
									</div>
							...
							<button id="submitBtn" type="submit" class="w-full opacity-95 text-white bg-green-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
				...
				<div class="hidden md:w-1/3 md:block p-8 sm:w-1/3 text-white z-50 shadow-xl dark:border dark:bg-gray-800 dark:border-gray-700">
					...
					<p class="text-lg text-justify">Agricultural Training Institute is the capacity builder, knowledge bank, and catalyst of the Philippine Agriculture and Fisheries extension system.</p>
