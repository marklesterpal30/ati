...
<html lang="en">
   ...
   <body>
      <div>
         <nav class="flex justify-between items-center w-screen bg-green-400 fixed top-0 left-0 py-1 z-50">
      ...
      <aside id="default-sidebar" class="fixed top-10 sm:top-16 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
         <div class="h-full px-3 py-4 overflow-y-auto bg-green-300 dark:bg-gray-800 shadow-xl  ">
